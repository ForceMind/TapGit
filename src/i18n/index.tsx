...
const ERROR_KEY_MAP: Partial<Record<string, MessageKey>> = {
  ...
  EMPTY_DESTINATION: 'error_empty_destination',
  INVALID_FOLDER_NAME: 'error_invalid_folder_name',
  TARGET_ALREADY_EXISTS: 'error_target_already_exists',
  CLONE_PROJECT_FAILED: 'error_clone_project_failed',
